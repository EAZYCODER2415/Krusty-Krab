      ...
      <main>
        ...
        <section className="menu-peek">
          ...
          <div className="container">
            <div className="child">
              <a href="#"><img src="/media/mr-krabs.jpg" alt="krabby-patty" className="burger2" /></a>
              <br />
            ...
            <div className="child">
              <a href="#"><img src="/media/squidward.jpeg" alt="coral-bits" className="burger2" /></a>
              <br />
            ...
            <div className="child">
              <a href="#"><img src="/media/spongebob.jpg" alt="pizza" className="burger2" /></a>
              <br />
